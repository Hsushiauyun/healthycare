package tw.tcnr04.mybottomnavi.ui.ambulance;
...
import tw.tcnr04.mybottomnavi.R;

public class ambulanceFragment extends Fragment {

    private AmbulanceViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(AmbulanceViewModel.class);
